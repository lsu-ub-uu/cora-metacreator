...
public class CollectionItemFactorySpy implements CollectionItemFactory {

	public MethodCallRecorder MCR = new MethodCallRecorder();
	public MethodReturnValues MRV = new MethodReturnValues();

	public CollectionItemFactorySpy() {
		MCR.useMRV(MRV);

		MRV.setDefaultReturnValuesSupplier(
				"factorCollectionItemUsingItemCollectionIdAndDataDivider", DataRecordGroupSpy::new);
	}
