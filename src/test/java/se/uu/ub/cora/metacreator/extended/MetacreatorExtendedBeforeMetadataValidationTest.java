...
public class MetacreatorExtendedBeforeMetadataValidationTest {
	...
	// assertEquals(functionalityForCreateBeforeMetadataValidation.size(), 2);
	// MetadataGroupTextCompleter textCompleter = (MetadataGroupTextCompleter)
	// functionalityForCreateBeforeMetadataValidation
	// .get(0);
	// assertEquals(textCompleter.getImplementingTextType(), CORA_TEXT);
	// assertTrue(textCompleter.getMetadataCompleter() instanceof MetadataCompleterImp);
	...
	// assertTrue(textCompleter.getMetadataCompleter() instanceof MetadataCompleterImp);
	//
	// ItemCollectionCreator itemCollectionCreator = (ItemCollectionCreator)
	// functionalityForCreateBeforeMetadataValidation
	// .get(1);
	...
	// assertEquals(functionalityForCreateBeforeMetadataValidation.size(), 2);
	//
	// GroupCompleter groupCompleter = (GroupCompleter)
	// functionalityForCreateBeforeMetadataValidation
	// .get(0);
	...
	// assertEquals(functionalityForCreateBeforeMetadataValidation.size(), 2);
	//
	// RecordLinkCompleter recordLinkCompleter = (RecordLinkCompleter)
	// functionalityForCreateBeforeMetadataValidation
	// .get(0);
	...
	// assertEquals(functionalityForCreateBeforeMetadataValidation.size(), 2);
	//
	// CollectionVariableCompleter collectionVarCompleter = (CollectionVariableCompleter)
	// functionalityForCreateBeforeMetadataValidation
	// .get(0);
