...
public class RecordTypeExtendedFunctionalityFactory implements ExtendedFunctionalityFactory {
	...
	private List<ExtendedFunctionality> createBeforeReturn(
			List<ExtendedFunctionality> functionalities) {
		functionalities.add(new SearchFromRecordTypeCreator());
		return functionalities;
	}
