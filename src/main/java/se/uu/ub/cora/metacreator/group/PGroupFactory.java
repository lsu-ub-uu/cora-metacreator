...
public final class PGroupFactory {
	...
	private PGroupFactory(String authToken, MetadataIdToPresentationId metadataIdToPresentationId) {
	...
	public static PGroupFactory usingAuthTokenAndMetadataToPresentationId(String authToken,
		...
		return new PGroupFactory(authToken, metadataPresentationId);
	}
